...
-- Instances: 170 | Scripts: 44 | Modules: 0 | Tags: 0
local G2L = {};
...
G2L["78"]["Size"] = UDim2.new(0.71832, 0, 0.11486, 0);
G2L["78"]["Name"] = [[red3]];
G2L["78"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["78"]["Text"] = [[Bigger Hitbox Close PPL]];
G2L["78"]["Visible"] = false;
G2L["78"]["Position"] = UDim2.new(0.13948, 0, 0.43973, 0);
...
G2L["84"] = Instance.new("TextLabel", G2L["2c"]);
...
G2L["84"]["TextColor3"] = Color3.fromRGB(178, 0, 0);
G2L["84"]["BackgroundTransparency"] = 1;
G2L["84"]["Size"] = UDim2.new(0.961, 0, 0.15324, 0);
G2L["84"]["Visible"] = false;
G2L["84"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["84"]["Text"] = [[Only Works if the Target is Injured And not Carried By another player]];
G2L["84"]["Name"] = [[first1Label]];
G2L["84"]["Position"] = UDim2.new(0.01645, 0, 0.81148, 0);
...
G2L["85"]["Size"] = UDim2.new(0.71832, 0, 0.11486, 0);
G2L["85"]["Name"] = [[red4]];
G2L["85"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["85"]["Text"] = [[inf stamina]];
G2L["85"]["Visible"] = false;
G2L["85"]["Position"] = UDim2.new(0.13948, 0, 0.57857, 0);
...
G2L["8b"]["Size"] = UDim2.new(0.71832, 0, 0.11486, 0);
G2L["8b"]["Name"] = [[red2]];
G2L["8b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["8b"]["Text"] = [[Esp Blue Team]];
G2L["8b"]["Visible"] = false;
G2L["8b"]["Position"] = UDim2.new(0.13948, 0, 0.29022, 0);
...
G2L["a2"] = Instance.new("TextButton", G2L["91"]);
G2L["a2"]["TextWrapped"] = true;
G2L["a2"]["TextTruncate"] = Enum.TextTruncate.AtEnd;
G2L["a2"]["BorderSizePixel"] = 0;
G2L["a2"]["TextColor3"] = Color3.fromRGB(240, 240, 240);
...
G2L["a2"]["Size"] = UDim2.new(0.75106, 0, 0.08456, 0);
G2L["a2"]["Name"] = [[five]];
G2L["a2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["a2"]["Text"] = [[unlock Dash]];
G2L["a2"]["Position"] = UDim2.new(0.09635, 0, 0.36328, 0);
...
G2L["a4"]["Thickness"] = 1.7;
G2L["a4"]["Color"] = Color3.fromRGB(155, 155, 155);


-- StarterGui.omarInkGame.Info.sigma.MiscFrame.five.soundclick
G2L["a5"] = Instance.new("LocalScript", G2L["a2"]);
G2L["a5"]["Name"] = [[soundclick]];


-- StarterGui.omarInkGame.Info.sigma.MiscFrame.five.fingerprint
G2L["a6"] = Instance.new("ImageLabel", G2L["a2"]);
G2L["a6"]["BorderSizePixel"] = 0;
G2L["a6"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
G2L["a6"]["Image"] = [[rbxassetid://12333784627]];
G2L["a6"]["Size"] = UDim2.new(0.13479, 0, 0.9265, 0);
G2L["a6"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["a6"]["BackgroundTransparency"] = 1;
G2L["a6"]["Name"] = [[fingerprint]];
G2L["a6"]["Position"] = UDim2.new(0.83573, 0, 0.05474, 0);
...
G2L["a8"] = Instance.new("LocalScript", G2L["a2"]);



-- StarterGui.omarInkGame.Info.drag localscript
G2L["a9"] = Instance.new("LocalScript", G2L["3"]);
G2L["a9"]["Name"] = [[drag localscript]];


-- StarterGui.omarInkGame.Changer
G2L["aa"] = Instance.new("LocalScript", G2L["1"]);
G2L["aa"]["Name"] = [[Changer]];
...
local script = G2L["53"];
	...
	local Status = ReplicatedStorage:WaitForChild("Chooser")
	local Players = game:GetService("Players")
	local player = Players.LocalPlayer
	...
	local buttonsToShow = {
		RedLightGreenLight = {"first", "second", "third", "first1"},
		LightsOut = {"third2"},
		GlassBridge = {"five1", "five2"},
		Mingle = {"six1"},
		HideAndSeek = {"seven1"}
	}
	
	local redButtons = {"red2", "red3", "red4"}
	local blueButtons = {"blue1", "blue2", "blue3"}
	...
	local function showButtonsForValue(value)
		hideAll()
		local names = buttonsToShow[value]
		if names then
			for _, name in ipairs(names) do
				local ui = frame:FindFirstChild(name)
				if ui then
					ui.Visible = true
				end
			end
			if value == "HideAndSeek" then
				local myChar = Live:FindFirstChild(player.Name)
				if myChar then
					if myChar:FindFirstChild("RedVest") then
						local label = frame:FindFirstChild("seven1")
						if label then
							label.Text = "Team is Red"
							label.TextColor3 = Color3.fromRGB(255, 0, 0)
						end
						for _, btnName in ipairs(redButtons) do
							local btn = frame:FindFirstChild(btnName)
							if btn then
								btn.Visible = true
							end
						end
					elseif myChar:FindFirstChild("BlueVest") then
						local label = frame:FindFirstChild("seven1")
						if label then
							label.Text = "Team is Blue"
							label.TextColor3 = Color3.fromRGB(0, 0, 255)
						end
						for _, btnName in ipairs(blueButtons) do
							local btn = frame:FindFirstChild(btnName)
							if btn then
								btn.Visible = true
							end
	...
	local chooserLabel = frame:FindFirstChild("Chooser")
	
	spawn(function()
		while true do
			if Status.Value == "" or not buttonsToShow[Status.Value] then
				if chooserLabel then
				...
				if chooserLabel then
					chooserLabel.Text = Status.Value
				end
				showButtonsForValue(Status.Value)
			end
			wait(1)
		end
	end)"
